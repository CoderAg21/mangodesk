    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950 font-sans p-4">
      <div className="w-full max-w-md p-10 bg-gray-900 rounded-xl shadow-2xl shadow-black/50 relative">
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" className="w-full py-3 bg-violet-600 text-white font-bold rounded-lg hover:bg-violet-700 transition duration-200 shadow-md shadow-violet-900/50 flex items-center justify-center">
          ...
          <p className="text-center mt-8 text-sm text-gray-400">
            ...
            <Link to="/signup" className="text-violet-400 font-semibold hover:text-white transition duration-200">
              Sign Up
            </Link>
          </p>
        </form>
